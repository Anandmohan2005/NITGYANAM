    ...
    <footer className="bg-charcoal text-white py-20 border-t border-white/5 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-16">
          ...
          <div className="space-y-6">
            <h4 className="text-gold font-black uppercase tracking-[0.3em] text-xs">Founders</h4>
            <div className="space-y-4">
              <div className="flex items-center space-x-4 group">
                <div className="w-10 h-10 rounded-xl bg-gold flex items-center justify-center text-charcoal shadow-lg group-hover:scale-105 transition-transform duration-500 overflow-hidden shrink-0">
              ...
              <div className="flex items-center space-x-4 group">
                <div className="w-10 h-10 rounded-xl bg-white/10 flex items-center justify-center text-white shadow-lg group-hover:scale-105 transition-transform duration-500 overflow-hidden shrink-0">
